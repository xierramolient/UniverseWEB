...
export default function Projects() {
    ...
    return <>
       ...
       ‎ 
                    ...
                    <p className="text-xl mt-1">
					xierraps.ddns.net:6411 | (SERVER CLOSED)
					</p>
					<a href="https://xierraps.xyz/404" className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-tr from-primary to-white hover:dark:text-white">( Visit Server )</a>
														  	        <p className="mx-auto max-w-4xl font-display text-1x1 text-gray-500/50 text-center">
       ‎ 
      </p>
	  														  	        <p className="mx-auto max-w-4xl font-display text-1x1 text-gray-500/50 text-center">
       ‎ 
	                        ...
	                        <div>
                                ...
                                >
								<i href="/genshinps" className="" />
                                <a href="/genshinps" className="text-zinc-400 hover:text-primary hover:dark:text-white">Back</a>
                                </a>
                            </div>
